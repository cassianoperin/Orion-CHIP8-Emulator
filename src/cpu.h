...
extern void opc_chip8_1NNN(unsigned short nnn);
extern void opc_chip8_2NNN(unsigned short nnn);
extern void opc_chip8_3XNN(unsigned char x, unsigned char nn);
extern void opc_chip8_4XNN(unsigned char x, unsigned char nn);
extern void opc_chip8_5XY0(unsigned char x, unsigned char y);
extern void opc_chip8_6XNN(unsigned char x, unsigned char nn);
extern void opc_chip8_7XNN(unsigned char x, unsigned char nn);
...
extern void opc_chip8_9XY0(unsigned char x, unsigned char y);
extern void opc_chip8_ANNN(unsigned short nnn);
extern void opc_chip8_BNNN(unsigned short nnn, unsigned char x);
extern void opc_chip8_CXNN(unsigned char x, unsigned char nn);
extern void opc_chip8_DXYN(unsigned char x, unsigned char y, unsigned char n);
