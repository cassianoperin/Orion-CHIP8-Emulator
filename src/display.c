...
bool display_draw(unsigned int frame)
{
	...
	// // Letter C
	// // Line 1
	// display_pixels[801]  = display_pixel_ON_color;
	// display_pixels[802]  = display_pixel_ON_color;
	// display_pixels[803]  = display_pixel_ON_color;
	// display_pixels[804]  = display_pixel_ON_color;
	// // Line 2
	// display_pixels[865]  = display_pixel_ON_color;
	// // Line 3
	// display_pixels[929]  = display_pixel_ON_color;
	// // Line 4
	// display_pixels[993]  = display_pixel_ON_color;
	// // Line 5
	// display_pixels[1057] = display_pixel_ON_color;
	// // Line 6
	// display_pixels[1121] = display_pixel_ON_color;
	// // Line 7
	// display_pixels[1185] = display_pixel_ON_color;
	// // Line 8
	// display_pixels[1249] = display_pixel_ON_color;
	// display_pixels[1250] = display_pixel_ON_color;
	// display_pixels[1251] = display_pixel_ON_color;
	// display_pixels[1252] = display_pixel_ON_color;

	// // Letter H
	// // Line 1
	// display_pixels[806]  = display_pixel_ON_color;
	// display_pixels[809]  = display_pixel_ON_color;
	// // Line 2
	// display_pixels[870]  = display_pixel_ON_color;
	// display_pixels[873]  = display_pixel_ON_color;
	// // Line 3
	// display_pixels[934]  = display_pixel_ON_color;
	// display_pixels[937]  = display_pixel_ON_color;
	// // Line 4
	// display_pixels[998]  = display_pixel_ON_color;
	// display_pixels[999]  = display_pixel_ON_color;
	// display_pixels[1000] = display_pixel_ON_color;
	// display_pixels[1001] = display_pixel_ON_color;
	// // Line 5
	// display_pixels[1062] = display_pixel_ON_color;
	// display_pixels[1065] = display_pixel_ON_color;
	// // Line 6
	// display_pixels[1126] = display_pixel_ON_color;
	// display_pixels[1129] = display_pixel_ON_color;
	// // Line 7
	// display_pixels[1190] = display_pixel_ON_color;
	// display_pixels[1193] = display_pixel_ON_color;
	// // Line 8
	// display_pixels[1254] = display_pixel_ON_color;
	// display_pixels[1257] = display_pixel_ON_color;

	// // Letter I
	// // Line 1
	// display_pixels[811]  = display_pixel_ON_color;
	// // Line 2
	// display_pixels[875]  = display_pixel_ON_color;
	// // Line 3
	// display_pixels[939]  = display_pixel_ON_color;
	// // Line 4
	// display_pixels[1003] = display_pixel_ON_color;
	// // Line 5
	// display_pixels[1067] = display_pixel_ON_color;
	// // Line 6
	// display_pixels[1131] = display_pixel_ON_color;
	// // Line 7
	// display_pixels[1195] = display_pixel_ON_color;
	// // Line 8
	// display_pixels[1259] = display_pixel_ON_color;

	// // Letter P
	// // Line 1
	// display_pixels[813]  = display_pixel_ON_color;
	// display_pixels[814]  = display_pixel_ON_color;
	// display_pixels[815]  = display_pixel_ON_color;
	// // Line 2
	// display_pixels[877]  = display_pixel_ON_color;
	// display_pixels[880]  = display_pixel_ON_color;
	// // Line 3
	// display_pixels[941]  = display_pixel_ON_color;
	// display_pixels[944]  = display_pixel_ON_color;
	// // Line 4
	// display_pixels[1005] = display_pixel_ON_color;
	// display_pixels[1007] = display_pixel_ON_color;
	// // Line 5
	// display_pixels[1069] = display_pixel_ON_color;
	// display_pixels[1070] = display_pixel_ON_color;
	// // Line 6
	// display_pixels[1133] = display_pixel_ON_color;
	// // Line 7
	// display_pixels[1197] = display_pixel_ON_color;
	// // Line 8
	// display_pixels[1261] = display_pixel_ON_color;

	// // Symbol -
	// // Line 1
	// display_pixels[1073]  = display_pixel_ON_color;
	// display_pixels[1074]  = display_pixel_ON_color;

	// // Number 8
	// // Line 1
	// display_pixels[820]  = display_pixel_ON_color;
	// display_pixels[821]  = display_pixel_ON_color;
	// display_pixels[822]  = display_pixel_ON_color;
	// display_pixels[823]  = display_pixel_ON_color;
	// // Line 2
	// display_pixels[884]  = display_pixel_ON_color;
	// display_pixels[887]  = display_pixel_ON_color;
	// // Line 3
	// display_pixels[948]  = display_pixel_ON_color;
	// display_pixels[951]  = display_pixel_ON_color;
	// // Line 4
	// display_pixels[1012]  = display_pixel_ON_color;
	// display_pixels[1013]  = display_pixel_ON_color;
	// display_pixels[1014]  = display_pixel_ON_color;
	// display_pixels[1015]  = display_pixel_ON_color;
	// // Line 5
	// display_pixels[1076] = display_pixel_ON_color;
	// display_pixels[1079] = display_pixel_ON_color;
	// // Line 6
	// display_pixels[1140] = display_pixel_ON_color;
	// display_pixels[1143] = display_pixel_ON_color;
	// // Line 7
	// display_pixels[1204] = display_pixel_ON_color;
	// display_pixels[1207] = display_pixel_ON_color;
	// // Line 8
	// display_pixels[1268] = display_pixel_ON_color;
	// display_pixels[1269] = display_pixel_ON_color;
	// display_pixels[1270] = display_pixel_ON_color;
	// display_pixels[1271] = display_pixel_ON_color;

	for ( int i = 0; i < sizeof(font_logo) / sizeof(font_logo[0]); i++ ) {
		int pos = font_logo[i];
		printf("%d: %d\n", i, pos);

		display_pixels[ pos ] = display_pixel_ON_color;
	}
